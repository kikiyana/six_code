...
def send_notification(new_citations):
    ...
    sender_email = 'abc261167@qq.com'
    sender_password = 'CC39fde21cfe3F02'
    recipient_email = 'xqzhu@qq.com'
    ...
    try:
        server = smtplib.SMTP_SSL('smtp.gmail.com', 587)    #mail.bjtu.edu.cn  465
        server.starttls()
