...
def load_protonet_conv(**kwargs):
    # 加载预训练模型
    net = resnet_model(avg_pool=True, num_classes=4)
    # 加载模型的权重
...
if __name__ == '__main__':
    ...
    train_x, test_x, train_y, test_y = train_test_split(trainx, trainy, test_size = 0.2, random_state=40, shuffle=True)#test_size小于0.2报错？
    ...
    model_out_name = 'models/model_1_test'+'.pt'
